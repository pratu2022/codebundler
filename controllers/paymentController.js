...
export const buySubscription = catchAsyncError(async(req,res,next)=>{
   ...
   const plan_id = process.env.PLAN_ID || "plan_O2qowoDaGdP3Sn"
...
export const cancelSubscription = catchAsyncError(async(req,res,next)=>{
    ...
    res.status(200).json({
        success:true,
        message: refund?"Subscrption Cancelled, You will receive Full refund in 7":"Subscrption Cancelled, Now refund initiated as subscrption was cancelled after 7 days",
    })
})